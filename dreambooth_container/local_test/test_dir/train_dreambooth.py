...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        help="The output directory where the generated image samples will be saved.",
    )
    ...
    parser.add_argument(
        "--center_crop", type=bool, default=False, help="Whether to center crop images before resizing to resolution"
    )
...
def main(args):
    ...
    def save_weights(step):
        ...
        if accelerator.is_main_process:
            ...
            # hardcoded the inference code in /opt/ml
            SRC_PATH = "/opt/program/code"
            if os.path.exists(SRC_PATH):
                DST_PATH = os.path.join(save_dir, "code")
